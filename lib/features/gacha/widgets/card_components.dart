...
class TypeLine extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final l10n = AppLocalizations.of(context)!;
    final typeStr = card.type == CardType.character ? l10n.typeCharacter : l10n.typeStory;
    final elementStr = getElementName(card.element, l10n);
...
String getElementName(CardElement element, AppLocalizations l10n) {
  switch (element) {
