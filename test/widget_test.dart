...
import 'package:plot_mixer/main.dart';
import 'package:plot_mixer/features/gacha/card_widget.dart';
...
void main() {
  testWidgets('Gacha spin smoke test', (WidgetTester tester) async {
    ...
    // but here we pump PlotMixerApp which includes ProviderScope? 
    // No, PlotMixerApp in main.dart is wrapped by ProviderScope in main function.
    // So we need to wrap it here too.
    
    await tester.pumpWidget(const ProviderScope(child: PlotMixerApp()));
